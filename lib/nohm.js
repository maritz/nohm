...
var ModelClass = {
  ...
  /**
   * Resets all properties and their internal additional variables to the default.
   * TODO: make sure the value of a property is really reset to the default. right now, changing the value, changes the default.
   */
