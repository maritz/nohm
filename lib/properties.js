...
/**
 * This resets the property meta data. Should be called internally after saving.
 */
exports.__resetProp = function resetProp(p) {
  ...
  //this.properties[p] = tmp; // if this fails, add back. referencing should work though
}
