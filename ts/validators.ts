...
export const validators: {
  [index: string]: validatiorFunction;
     ...
     */
    alphanumeric: function alphanumeric(value: any, _options: any): Promise<boolean> {
     ...
     * Can be optional.
     */
    date: function date(value: any, _options: any): Promise<boolean> {
     ...
     */
    dateISO: function dateISO(value: any, _options: any): Promise<boolean> {
     ...
     */
    digits: function digits(value: any, _options: any): Promise<boolean> {
     ...
     */
    email: function email(value: any, _options: any): Promise<boolean> {
     ...
     */
    length: function length(value: any, options: any): Promise<boolean> {
      if (options.trim) {
        ('' + value).trim();
      }
     ...
     */
    minMax: function minMax(value: any, options: any): Promise<boolean> {
      value = +value;
     ...
     */
    notEmpty: function notEmpty(value: any, options: any): Promise<boolean> {
     ...
     */
    number: function number(value: any, _options: any): Promise<boolean> {
     ...
     */
    numberEU: function numberEU(value: any, _options: any): Promise<boolean> {
      return Promise.resolve(/^-?(?:\d+|\d{1,3}(?:\.\d{3})+)(?:\,\d+)?$/.test(value));
    },
     ...
     * string or is optional (params[0]) and empty
     */
    numberSI: function numberSI(value: any, _options: any): Promise<boolean> {
      return Promise.resolve(/^-?(?:\d+|\d{1,3}(?: \d{3})+)(?:[\,\.]\d+)?$/.test(value));
    },
     ...
     * string or is optional (params[0]) and empty
     */
    numberUS: function numberUS(value: any, _options: any): Promise<boolean> {
      return Promise.resolve(/^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$/.test(value));
    },
     ...
     */
    regexp: function regexp(value: any, options: any): Promise<boolean> {
      if (options.regex instanceof RegExp) {
        return Promise.resolve(options.regex.test(value));
      } else {
        return Promise.resolve(new RegExp(options.regex).test(value));
      }
    },
     ...
     */
    url: function url(value: any, _options: any): Promise<boolean> {
      return Promise.resolve(regexps.url.test(value));
    },
  };

declare var window: any;
declare var nohmValidationsNamespaceName: string;
...
if (typeof (window) !== 'undefined' && typeof (nohmValidationsNamespaceName) !== 'undefined') {
  ...
  // TODO: remove any ?
  const nohm: any | NohmClass = window[nohmValidationsNamespaceName];
